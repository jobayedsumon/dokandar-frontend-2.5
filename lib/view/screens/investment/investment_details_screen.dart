...
//   const InvestmentDetailsScreen({Key? key, required this.investmentModel, required this.packageId, this.fromNotification = false, this.fromOfflinePayment = false, this.contactNumber}) : super(key: key);
//
//   @override
...
//     await Get.find<OrderController>().trackOrder(widget.packageId.toString(), reload ? null : widget.investmentModel, false, contactNumber: widget.contactNumber).then((value) {
//       if(widget.fromOfflinePayment) {
//         Future.delayed(const Duration(seconds: 2), () => showAnimatedDialog(context, OfflineSuccessDialog(packageId: widget.packageId)));
//       }
//     });
//     Get.find<OrderController>().timerTrackOrder(widget.packageId.toString(), contactNumber: widget.contactNumber);
//     Get.find<OrderController>().getOrderDetails(widget.packageId.toString());
//   }
//
//   void _startApiCall(){
...
//           InvestmentModel? order = orderController.trackModel;
//           bool parcel = false;
...
//   );
//
//   Widget _bottomView(OrderController orderController, InvestmentModel order, bool parcel, double totalPrice) {
...
//                   Get.dialog(CancellationDialogue(packageId: order.id));
//                 },
