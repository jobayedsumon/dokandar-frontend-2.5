...
class InvestmentScreenState extends State<InvestmentScreen> with TickerProviderStateMixin {
  ...
  void initCall(){
    if(Get.find<AuthController>().isLoggedIn()) {
      Get.put(InvestmentController(investmentRepo: InvestmentRepo(apiClient: Get.find(), sharedPreferences: Get.find())));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(title: 'Investment', backButton: ResponsiveHelper.isDesktop(context)),
            ...
            Container(
              ...
              child: Column(children: [
                ResponsiveHelper.isDesktop(context) ? Center(child: Padding(
                  ...
                  child: Text('Investment', style: robotoMedium),
                )) : const SizedBox(),
