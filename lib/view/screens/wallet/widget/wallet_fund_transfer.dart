                  ...
                  children: [
                    TableRow(
                      ...
                      Padding(
                        ...
                        child: Text('Amount', style: robotoRegular.copyWith(
                            fontSize: Dimensions.fontSizeExtraLarge, color: Theme
                                .of(context)
                                .primaryColor, fontWeight: FontWeight.bold)),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text('Recipient ID', style: robotoRegular.copyWith(
                            fontSize: Dimensions.fontSizeExtraLarge, color: Theme
                                .of(context)
                                .primaryColor, fontWeight: FontWeight.bold)),
                      )
                    ...
                    TableRow(children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text(numberWithCountryCode, style: robotoMedium
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text('Transfer your wallet balance to someone.',
              style: robotoRegular.copyWith(
                  fontSize: Dimensions.fontSizeSmall, color: Theme
                  .of(context)
                  .disabledColor),
              maxLines: 2,
